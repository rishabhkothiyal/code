...
def opendetiles():
    spacek("you want to only see the user deties or i should speak")
...
def username(s1):
    try:
     ...
     with open("data of user.text","a") as e:
        ...
        username(s1)
def takecommend():
    """this takes micorphone input from the user and returns string output"""
    r = sr.Recognizer()
    ...
    return query
def stoplisting():
    spacek("for how much second  you want to stop jarvis  from listening commands")
    try:
        a = int(takecommend())
    ...
    while (1):
        ...
        try:
            ...
            if 'akhilesh' in s1:
                ...
                spacek("plesae identify your self Are you a male of female  !")
     ...
     while (1):
        ...
        try:
            ...
            if 'wikipedia' in queuery:
                ...
                codepath = "C:\\Users\\Rishabh Kothiyal\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
                ...
                spacek(
                    f"you opened anotheer programe {sex}would like to stop me from listing if yes please said stop listening or dont listen")
            elif 'search' in queuery:
                s = webbrowser.open(queuery)

                spacek(s)
                spacek(
                    f"you opened another programe{sex} would like to stop me from listing if yes please said stop listening or dont listen")
                ...
                spacek("I'm fine, thank you for asking")
                ...
                spacek("I have been created by rishu.")
                ...
                spacek(f"sorry {sex} because of me you face some problem "
                       "sir some time i dont work properly there are  few reason that are low internet connection or some noise "
                       "that i unable to understand i am working on that i will  make sure you will not face this problem again")
            ...
            elif " do u know rishu " in queuery:
                spacek(
                    f"yes{sex} i know him becuase of him i am able to talk to you he is a very nice person would you like to know more about mister rishu")
                s = takecommend().lower()
                if s == "yes":
                    me1()
                else:
 ...
 while True:
  try:
    ...
    if 'yes' in s1:
      ...
      spacek("i could not understand sir plesase speak again")
